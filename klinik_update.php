...
if(isset($_POST['submit'])) {
  ...
  $klinik_update = "UPDATE klinik SET nama='$nama', alamat='$alamat', telfon='$telfon', gambar='$gambar' WHERE id=$id";
  $res = mysqli_query($conn,$klinik_update);
  if($res) {
  ...
  <div class="container" style="padding-left: 100px; padding-top: 50px;">
    ...
    <div>
      ...
      <form method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="input-field col s6">
            <input id="telfon" type="text" name="telfon" value="<?php echo $r['telfon']; ?>" data-length="12">
            <label for="telfon">Nomor Telfon</label>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s8">
            <textarea id="alamat" class="materialize-textarea" name="alamat"><?php echo $r['alamat']; ?></textarea>
            <label for="alamat">Alamat RS/Klinik</label>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s6">
            <p> Unggah Gambar (max. 1 MB) <br> *unggah lagi gambar jika tidak ingin mengganti gambar </p> <input type="file" name="gambar" id="gambar">
          </div>
        </div>
        <div class="row">
          <div class="input-field col s6">
